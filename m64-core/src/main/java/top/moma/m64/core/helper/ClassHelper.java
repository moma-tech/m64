 ...
 * ClassHelper
 *
 * <p>Ref. com.baomidou.mybatisplus.core.toolkit;
 *
 * @author Ivan
 * @version 1.0 Created by Ivan at 2020/11/16.
 */
public class ClassHelper {
  ...
  public static <T> T newInstance(Class<T> clazz) {
    try {
      ...
      throw new M64Exception("实例化对象时出现错误,请尝试给 " + clazz.getName() + " 添加无参的构造方法", e);
    }
  }
  ...
  public static Class<?> toClassConfident(String name) {
    try {
      ...
      try {
        ...
        throw new M64Exception("找不到指定的class！请仅在明确确定会有 class 的时候，调用该方法", e);
      }
    }
  }
